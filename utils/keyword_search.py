...
def create_keyword_list():
    keywords = {
        ...
        'github': r"\b(github)\b",
        'Corresponding_Author': r'\bCorresponding author\b.*\bE-mail: [A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b',
        'Editorial_Decision': r'\bEditorial decision \d{1,2} [A-Za-z]+ \d{4}\b',
        'Accepted_Date': r'\bAccepted \d{1,2} [A-Za-z]+ \d{4}\b',
        'Research_Method': r'\b(methodology|research method|materials and methods|methods and materials|experimental design|study design)\b'
    }
